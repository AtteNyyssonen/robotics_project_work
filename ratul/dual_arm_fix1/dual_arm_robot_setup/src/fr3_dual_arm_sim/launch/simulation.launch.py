...
def generate_launch_description():
    ...
    # NEW: load joint limits and wrap as robot_description_planning
    joint_limits_file_path = os.path.join(pkg_moveit_description, 'config', 'joint_limits.yaml')
    with open(joint_limits_file_path, 'r') as f:
    ...
    # NOTE: controller_manager_node REMOVED – Gazebo plugin will create controller_manager
